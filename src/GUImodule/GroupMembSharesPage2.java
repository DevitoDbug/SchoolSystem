...
public class GroupMembSharesPage2 extends JFrame  implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GroupMembSharesPage2 frame = new GroupMembSharesPage2();
	...
	public GroupMembSharesPage2() {
		...
		selectMembPanel = new RoundedPanel3(20 , new Color(221, 160, 221));
		...
		selectMembPanel.setLayout(new BorderLayout());
							    ...
							    for (int i = 0; i < groupMemberFromsql.size(); i++) {
									...
									panel.setLayout(new GridLayout(2, 3, 20, 20));
											...
											nameINlist.setText(groupMemberFromsql.get(i).getfName_sql().toUpperCase());
											nameINlist.setFont(new Font("Segoe UI Semibold", Font.PLAIN,15));
											nameINlist.setForeground(new Color(30, 47, 47));
											...
											String name = groupMemberFromsql.get(i).getfName_sql();
											String id =groupMemberFromsql.get(i).getGoup_ID_sql() ;
											String groupID = groupMemberFromsql.get(i).getRegID_sql() ;
											
										    gbc.gridwidth = 10;
											infoINlist = new JLabel("<html>Group Member"+"<br>Group ID:  -" + id +" <br>Member ID: " + groupID +" <br>Name: " + name +" </html>");
						        ...
						        memberListPanel.add(Panellist, gbc);
								...
								selectMembPanel.add(scrollPane, BorderLayout.CENTER);
		...
		lblNewLabel_4.setIcon(new ImageIcon(GroupMembSharesPage2.class.getResource("/resourcesPics/folder-users-icon (1).png")));
		...
		lblNewLabel_5 = new JLabel("Hi, "+ name);
		...
		lblNewLabel_8.setIcon(new ImageIcon(GroupMembSharesPage2.class.getResource("/resourcesPics/dropdown.jpg")));
		...
		toolbarPanel.setLayout(sl_ContributePanel1);
			         ...
			         inMembers = new JMenuItem("Individual Members ");  
			         inMembers.addActionListener(this);

			         home = new JMenuItem("Home "); 
			         home.addActionListener(this);

			        popupmenu.add(inMembers); popupmenu.add(home);   
		...
		lblNewLabel.setIcon(new ImageIcon(GroupMembSharesPage2.class.getResource("/resourcesPics/Data-List-icon (1).png")));
	...
	public	void fromsql ()
	{
		groupMemberFromsql = groupMemberRegLogic.memberInfoList_sql;
